...
//   src/app/lib/prod-replica-sellers-seed.ts   (25 sellers, real names/phones)
//   src/app/lib/prod-replica-companies-seed.ts (production companies from beats)
//   src/app/lib/prod-replica-beats-seed.ts     (568 beats with polygons)
const fs = require('fs');
...
// as of 2026-07-30: real names, phone numbers and business names, so local
...
// seller-portal.bms.qwipo.com on 2026-07-24. Source data:
