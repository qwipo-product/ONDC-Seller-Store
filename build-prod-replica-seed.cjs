...
const S = {
  ...
  // ---- added 2026-09-08 (were hand-appended to the sellers seed with no
  // beats; polygons captured from production the same day — ids kept) ----
  'KANTA MARKETING':            { id: 'seller-prod-kanta',           city: 'Secunderabad', state: 'Telangana', pinCode: '500080', latitude: 17.4246661, longitude: 78.5006219, fullAddress: 'ground floor, 6-4-505/12, MIGH COLONY, NEW BHOIGUDA, SECUNDERABAD, Hyderabad, Telangana, 500080', gstin: '36AADFK1594Q1ZQ' },
  'NOOR ENTERPRISES':           { id: 'seller-prod-noor',            city: 'Secunderabad', state: 'Telangana', pinCode: '500061', latitude: 17.42011, longitude: 78.5019484, fullAddress: 'Shabadguda, H No. 11-3-357/1, Warsi Guda, Secunderabad, Hyderabad, Telangana, 500061', gstin: '36CGLPM7126A1ZI' },
  'YLN TRADERS':                { id: 'seller-prod-yln-traders',     city: 'Hyderabad South East', state: 'Telangana', pinCode: '500074', latitude: 17.353263, longitude: 78.560117, fullAddress: 'Ground floor, 7-4-29, Bai ramalguda, Near Bommarillu Restuarant, Yashodhara Nagar, Hyderabad, Rangareddy, Telangana, 500074', gstin: '36CGIPK0475P1ZU' },
  'KARTHIKEYA ENTERPRISES':     { id: 'seller-prod-karthikeya',      city: 'Secunderabad', state: 'Telangana', pinCode: '500040', latitude: 17.4599962, longitude: 78.5539783, fullAddress: '43-268, Hanuman Nagar, Moula Ali, Hyderabad, 500040', gstin: '36BNJPK8886P1ZS' },
  'LAKSHMI VENKATESWARA DISTRIBUTORS': { id: 'seller-prod-lakshmi-venkateswara', city: 'Secunderabad', state: 'Telangana', pinCode: '500062', latitude: 17.475783, longitude: 78.570397, fullAddress: 'LIG-203, APIIC Colony, Kamalanagar, ECIL Post, Hyderabad - 500062', gstin: '36AMRPK8162G1ZL' },
};
...
// as of 2026-09-08: real names, phone numbers and business names, so local
...
// for HANUMAN ENTERPRISES and RASVITHA TRADERS + 2026-09-08 additions for
// KANTA MARKETING, NOOR ENTERPRISES, YLN TRADERS, KARTHIKEYA ENTERPRISES,
// LAKSHMI VENKATESWARA DISTRIBUTORS, MAS MARKETING and YLN AGENCIES). Source:
