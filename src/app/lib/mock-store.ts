...
// deactivated.
// v11 (2026-09-11): three Charges & Fees demo sellers added at the top of
// the roster (Distributor / Wholesaler / Hybrid).
// v12 (2026-09-11): demo sellers slimmed to a small company roster (8 each)
// for a clearer, more legible Charges & Fees tab. Bump forces a re-seed.
const SELLERS_KEY = "qwipo.mock.sellers.v12";
